...
exports.checkGitIgnoreForEnv = checkGitIgnoreForEnv;
const vscode = require("vscode");
const fs = require("fs");
const path = require("path");
async function checkGitIgnoreForEnv() {
    ...
    if (!isIgnored) {
        const action = await vscode.window.showWarningMessage('⚠️ SECURITY ALERT: Your .env file is not ignored in .gitignore! You risk committing secrets.', 'Fix it for me', 'Ignore');
